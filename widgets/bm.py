...
try:
    from ..tools.xoppy_calc import xoppy_calc_bm
except ImportError:
...
class OWbm(widget.OWWidget):
    ...
    BFIELD_T = Setting(0.800000011920929)
    BEAM_ENERGY_GEV = Setting(6.039999961853027)
    CURRENT_A = Setting(0.100000001490116)
