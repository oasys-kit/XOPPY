...
try:
    from orangecontrib.xoppy.util.xoppy_calc import xoppy_calc_und_power_density
except ImportError:
    print("compute pressed.")
    print("Error importing: xoppy_calc_und_power_density")
    raise

class OWund_power_density(widget.OWWidget):
    name = "und_power_density"
    id = "orange.widgets.dataund_power_density"
    description = "xoppy application to compute..."
    icon = "icons/xoppy_und_power_density.png"
    author = "create_widget.py"
    maintainer_email = "srio@esrf.eu"
    priority = 10
    category = ""
    keywords = ["xoppy", "und_power_density"]
    ...
    GAPH = Setting(0.001)
    GAPV = Setting(0.001)
    HSLITPOINTS = Setting(101)
    VSLITPOINTS = Setting(51)
    METHOD = Setting(0)
