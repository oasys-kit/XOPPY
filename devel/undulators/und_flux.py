...
try:
    from orangecontrib.xoppy.util.xoppy_calc import xoppy_calc_und_flux
except ImportError:
    print("compute pressed.")
    print("Error importing: xoppy_calc_und_flux")
    raise
