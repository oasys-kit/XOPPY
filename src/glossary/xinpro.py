...
#try:
#    from ..tools.xoppy_calc import xoppy_calc_xinpro
#except ImportError:
...
class OWxinpro(widget.OWWidget):
    ...
    def unitFlags(self):
         return ['True','False','True','True','True','True','True','True','True','True','True','self.SCALE  ==  1','self.SCALE  ==  1']
