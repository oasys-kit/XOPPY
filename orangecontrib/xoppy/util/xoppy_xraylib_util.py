...
def bragg_calc(descriptor="Si",hh=1,kk=1,ll=1,temper=1.0,emin=5000.0,emax=15000.0,estep=100.0,ANISO_SEL=0,fileout=None):
    """
...
##  For backward compatible
    ...
    if unique_AtomicName[0] !='':
        ...
        for z in unique_AtomicName:
            ...
            unique_Zatom.append(xraylib.SymbolToAtomicNumber(tmp.group(0)))
...
#
    output_dictionary["fraction"] = list_fraction
